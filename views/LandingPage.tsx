...
import { ChevronRight, Target, Heart, ShieldCheck, MapPin, Sparkles } from 'lucide-react';
...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white selection:bg-[#002366] selection:text-white">
      {/* Navigation Header */}
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-700 ${scrolled ? 'bg-white/95 backdrop-blur-2xl border-b border-slate-200 py-3 shadow-md' : 'bg-transparent py-8'}`}>
          ...
          <div className="max-w-4xl space-y-12 animate-in fade-in slide-in-from-bottom-16 duration-1000 fill-mode-both">
            ...
            <div className="flex flex-col sm:flex-row gap-6 pt-10">
              ...
              <button 
                ...
                className="px-14 py-6 bg-white/5 backdrop-blur-2xl border border-white/20 text-white rounded-[2rem] font-black uppercase tracking-[0.2em] text-[12px] hover:bg-white/10 transition-all duration-500"
              >
                Registry Login
              </button>
            </div>
